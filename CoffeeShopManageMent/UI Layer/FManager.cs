...
namespace CoffeeShopManageMent.UI_Layer
{
    ...
    public partial class FManager : Form
    {
        ...
        private void dtgvBill_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void dtgvItem_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
